...
class Income extends BaseController
{
    ...
    public function save()
    {
        ...
        $postData = [
            ...
            'partner_pension' => $hasPartner ? ($this->request->getPost('partner_pension') ?: 0) : 0,
            'partner_pension_start_age' => $hasPartner ? ($this->request->getPost('partner_pension_start_age') ?: null) : null,
            'other_income' => $ownOther + ($hasPartner ? $partnerOther : 0),
            'minimum_monthly_income' => $this->request->getPost('minimum_monthly_income') ?: 0,
            'income_stops_at_retirement' => $this->request->getPost('income_stops_at_retirement') ? 1 : 0,
